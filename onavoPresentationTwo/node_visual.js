...
var yAxis = d3.svg.axis()
	...
	.tickFormat(function(d,i) {
		...
		return ['TuneIn','TuneIn','iHeartRadio','Pandora','Shazam','Stitcher','Songza','Slacker R.','Podcasts'][d];
	});
...
d3.json("data.json", function(data) {
	...
	svg.append("g")
		.attr("class", "y axis")
		.attr("transform", "translate(" + (width-pad+20) + ", 10)")
		.call(yAxis);
...
*/
	...
	text
		...
		.attr("x", function(d,i) {return x(d.date) + 46} )
...
/*
        ...
        title: function() {
          	var d = this.__data__;
          		return 'Hi there! My color is ' + d.app; 
        	}
