var m = [80, 160, 0, 150], // top right bottom left
    w = 1280 - m[1] - m[3], // width
    h = 800 - m[0] - m[2], // height
    x = d3.scale.linear().range([0, w]),
    y = 25, // bar height
    z = d3.scale.ordinal().range(["red", "#aaa"]); // bar color
	...
	var svg = d3.select("#barHierarchalViz").append("svg:svg")
	...
	d3.json("hierarchalBarData.json", function(root) {
