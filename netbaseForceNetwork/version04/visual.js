...
var buttonShowArrows = d3.select("#buttons")
    .append("input")
    .attr("class", "btn btn-info")
    .attr("id", "button_showarrows")
    .attr("type","button")
    .attr("value", "Show arrows");
...
//dat chrome GUI
var gui = new dat.GUI();
var config = {'charge':-500, 'gravity':0.15, 'friction': 0.8, 'link distance':180};

var charger = gui.add(config, "charge", -900, 0);
...
var frictey = gui.add(config, "friction", 0, 1);
frictey.onChange(function(value) {
	force.friction(value);
	force.start();
})

var linkdistey = gui.add(config, "link distance", 0, 600);
linkdistey.onChange(function(value) {
