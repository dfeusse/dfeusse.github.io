...
{"metric":"impression_page","date":41448,"paid":92213605,"organic":3261511,"viral":2843668},
...
var svg = d3.select("#impressions_page_organic").append('svg')
	.attr({
		height: 195,
		width: 110
	});
...
x.domain([0, d3.max(data, function(d) {return d.organic;}) ])
y.domain(data.map(function(d) { return d.date; }));
widthScale.domain([0, d3.max(data, function(d) {return d.organic;}) ])
...
max_value = d3.max(data, function(d) {return d.organic;})
svg.append("g")
    .attr("class", "x axis")
