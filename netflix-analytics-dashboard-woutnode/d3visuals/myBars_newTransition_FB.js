...
*/
	...
	d3.select(".title_eachbar").selectAll(".title_eachbar_text")
		.data(data)
		.text(function(d) {
			if (d.metric == "posts") {return 'Total Page Likes'}
			else if (d.metric == "impressions") {return 'New Page Likes'}
		    else if (d.metric == "passion") {return 'Unlikes / Likes'}
		    else if (d.metric == "positive sentiment") {return 'Engagement'}
		    else if (d.metric == "negative sentiment") {return 'Post Virality'}
		    else if (d.metric == "net sentiment") {return 'Page PTAT'}
	})
